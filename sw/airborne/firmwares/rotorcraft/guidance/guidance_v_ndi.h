...
/** @file firmwares/rotorcraft/guidance/guidance_v_ndi.h
 *  Vertical guidance for rotorcrafts using ndi control.
 *
 */

#ifndef GUIDANCE_V_NDI_H
#define GUIDANCE_V_NDI_H

#include "std.h"

#include "firmwares/rotorcraft/guidance/guidance_v_pch_ref.h"
