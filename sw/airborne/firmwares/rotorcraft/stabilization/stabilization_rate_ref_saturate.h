...
/** @file firmwares/rotorcraft/stabilization/stabilization_rate_ref_saturate.h
 *  Common rotorcraft rate reference saturation include.
 */

#ifndef STABILIZATION_RATE_REF_SATURATE_H
...
#endif /* STABILIZATION_RATE_REF_SATURATE_H */
