...
/**
 * @file firmwares/rotorcraft/stabilization/stabilization_attitude_ref_int.c
 *
...
#define OMEGA_P   STABILIZATION_RATE_REF_OMEGA_P
#define ZETA_P    STABILIZATION_RATE_REF_ZETA_P
...
#define OMEGA_Q   STABILIZATION_RATE_REF_OMEGA_Q
#define ZETA_Q    STABILIZATION_RATE_REF_ZETA_Q
...
#define OMEGA_R   STABILIZATION_RATE_REF_OMEGA_R
#define ZETA_R    STABILIZATION_RATE_REF_ZETA_R
...
struct Int32Rates  stab_rate_ref_rate;
struct Int32Rates  stab_rate_ref_accel;
struct Int32Rates  stab_rate_ref_jerk;

struct Int32RefModel stab_rate_ref_model = {
  {STABILIZATION_RATE_REF_OMEGA_P, STABILIZATION_RATE_REF_OMEGA_Q, STABILIZATION_RATE_REF_OMEGA_R},
  {STABILIZATION_RATE_REF_ZETA_P, STABILIZATION_RATE_REF_ZETA_Q, STABILIZATION_RATE_REF_ZETA_R}
};
